...
class Theme3 : AppCompatActivity() {

    //Data extra
    private var theme: String = "Clinica"
    ...
    private fun drawLines(){
        ...
        val toSpace2 = Line(this, actor1, space2)
        val toSpace3 = Line(this, actor1, space3)
        val toSpace4 = Line(this, actor1, space4)
        val toSpace5 = Line(this, actor1, space5)
    ...
    fun setOptionsAndActorsText() {
        ...
        option1.text = actor1Cases?.getOrNull(0)
        option2.text = actor1Cases?.getOrNull(1)
        option3.text = actor1Cases?.getOrNull(2)
        option4.text = actor1Cases?.getOrNull(3)
        option5.text = actor1Cases?.getOrNull(4)

        option6.text = actor2Cases?.getOrNull(0)
    }
